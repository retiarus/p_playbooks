...
#c.JupyterHub.data_files_path = '/usr/local/anaconda/share/jupyterhub'
...
c.JupyterHub.ssl_cert = '/var/lib/jupyterhub/jupyterhub.crt'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
c.JupyterHub.ssl_key = '/var/lib/jupyterhub/jupyterhub.key'
